...
function addExpenseToDOM(key,valueObj){		// (recibe el VALUE) esta funcion maneja la interaccion con el DOM una vez que ya tenemos el valor de la nota, la insertamos									
...
function deleteExpense(event){
	...
	let key = elementClicked.parentNode.id;
